...
export const BP_ONE_MEASURE_LOCKED_PURPOSES = [EDUCATION_BOARD_PURPOSE];
...
export const getItemsForPurpose = (purpose, currentItems = {}) => {
  ...
  if (purpose === '特定健診(国保)') {
    ...
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, xRay: true, ecg: true, blood: true, pulse: true, colorVision: true });
