...
export const SUMITOMO_PURPOSE = '住友生命';
export const SUMITOMO_NOTE = '住友生命 委託検査扱';
export const SUMITOMO_BLOOD_NOTE = '採血はコリンエステラーゼも';
// 情報提供・情報提供 後期高齢：料金0円・血圧2回・採血セット3（既定の腹囲チェックのみ異なる）
export const INFO_PROVISION_ELDERLY_PURPOSE = '情報提供 後期高齢';
export const INFO_PROVISION_PURPOSES = ['情報提供', INFO_PROVISION_ELDERLY_PURPOSE];
export const EDUCATION_BOARD_PURPOSE = '教育委員会';
export const EDUCATION_BOARD_BLOOD_NOTE = '血液一般検査、ＧＯＴ、ＧＰＴ、γ－ＧＴ、ＬＤＬコレステロール、ＨＤＬコレステロール、中性脂肪（ＴＧ）、血糖';
export const BLOOD_NOTE_REFERENCE_PURPOSES = [
  ...KURITAS_PURPOSES,
  'ハピルスB', 'ハピルスC', 'ハピルス雇入時', 'ハピルス深夜業',
...
export const getCompanyBillingLabel = (purpose) => {
  ...
  if (purpose === EDUCATION_BOARD_PURPOSE) return '教育委員会請求';
  return null;
};
...
export const ZERO_FEE_PURPOSES = ['特定健診(国保)', '長寿健診', ...INFO_PROVISION_PURPOSES, '入園児'];
...
export const buildReservationItemsFromRow = (row = {}) => ({
  ...
  blood: rowFlag(row, 'item_blood') || BLOOD_NOTE_REFERENCE_PURPOSES.includes(row?.purpose),
...
export const getItemsForPurpose = (purpose, currentItems = {}) => {
  ...
  if (purpose === '特定健診(国保)') {
  ...
  } else if (purpose === '情報提供') {
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, urine: true, ecg: true });
  } else if (purpose === INFO_PROVISION_ELDERLY_PURPOSE) {
    return allOff({ heightWeight: true, bloodPressure: true, urine: true, ecg: true });
  } else if (purpose === '入園児') {
    return allOff({ heightWeight: true });
  } else if (purpose === 'クリタス定期健診') {
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, xRay: true, ecg: true, blood: true, bloodKuritasRegular: true, hba1c: true });
  } else if (purpose === 'クリタス特定業務') {
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, ecg: true, blood: true, bloodKuritasSpecific: true });
    ...
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, xRay: true, ecg: true, blood: true, bloodHapilusB: true });
  } else if (purpose === 'ハピルスC') {
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, xRay: true, ecg: true, blood: true, bloodHapilusC: true });
  } else if (purpose === 'ハピルス雇入時') {
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, xRay: true, ecg: true, blood: true, bloodHapilusHire: true });
  } else if (purpose === 'ハピルス深夜業') {
    return allOff({ heightWeight: true, abdominalGirth: true, bloodPressure: true, vision: true, hearing: true, urine: true, ecg: true, blood: true, bloodHapilusNight: true });
  ...
  } else if (purpose === EDUCATION_BOARD_PURPOSE) {
    return allOff({ abdominalGirth: true, bloodPressure: true, urine: true, ecg: true, blood: true });
    ...
    return allOff({ heightWeight: true, bloodPressure: true, pulse: true, urine: true });
  } else if (purpose === 'オリックス生命') {
    return allOff({ heightWeight: true, bloodPressure: true, pulse: true, urine: true });
  } else if (purpose === SUMITOMO_PURPOSE) {
    return allOff({ heightWeight: true, bloodPressure: true, urine: true, blood: true, hba1c: true });
