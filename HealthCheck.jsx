      ...
      <div className="w-full max-w-[1400px] flex flex-col lg:flex-row gap-6 lg:h-full lg:min-h-0">
        ...
        <div className="flex-1 space-y-1 print-hide relative lg:flex lg:flex-col lg:min-h-0 [&_label.text-slate-400]:text-slate-600 [&_label.text-slate-500]:text-slate-600 [&_div.text-slate-400]:text-slate-600 [&_div.text-slate-500]:text-slate-600">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-[1.35rem] font-black text-slate-700 tracking-wide ml-[5mm]">健康診断予約・診断書作成システム<span className="text-[0.675rem] font-medium text-slate-400 ml-2">ver.2026.09.09</span></h1>
            <button
                ...
                {leftTab === 'result' && (
                  <div className="space-y-5 [&_.text-slate-400]:text-slate-600 [&_.text-slate-500]:text-slate-600">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 space-y-4 [&_.leading-tight]:flex [&_.leading-tight]:h-8 [&_.leading-tight]:items-center [&_.leading-tight]:justify-center">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-5 gap-2">
                            {[
                              { label: '総コレステロール', name: 'tCho' },
                              { label: 'HDL-C(mg/dL)', name: 'hdl' },
                              { label: 'LDL-C(mg/dL)', name: 'ldl' },
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-4 gap-2">
                            {[
                              { label: '尿素窒素(mg/dL)', name: 'un' },
                              { label: 'クレアチニン(mg/dL)', name: 'cre' },
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-4 gap-2">
                            {[
                              ...
                              { label: '無機リン(mg/dL)', name: 'ip' },
                              { label: 'Mg(mg/dL)', name: 'mgElec' },
                              { label: '血清鉄(μg/dL)', name: 'fe' },
                            ].map(({ label, name }) => (
                              <div key={name} className="space-y-0.5">
                                <div className="text-[10px] text-slate-500 text-center leading-tight">{label}</div>
                                <div className="flex items-center gap-0.5">
              ...
              <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowBackupModal(false)}>
                <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[92vh] overflow-y-auto" style={{minHeight: '80vh'}} onClick={e => e.stopPropagation()}>
                  ...
                  <div className="px-8 py-5">
                    <div className="text-sm font-bold text-slate-600 mb-3">Storage 内のバックアップ（{backupList.length} 件 / 最大7日分保持）</div>
