      ...
      <div className="w-full max-w-[1400px] flex flex-col lg:flex-row gap-6 lg:h-full lg:min-h-0">
        ...
        <div className="flex-1 space-y-4 print-hide relative lg:flex lg:flex-col lg:min-h-0">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-[1.35rem] font-black text-slate-700 tracking-wide ml-[5mm]">健康診断予約・診断書作成システム<span className="text-[0.675rem] font-medium text-slate-400 ml-2">ver.2026.06.21</span></h1>
            <button
